                                   ...
                                   // otherwise
{
    ...
    for (int i = 2; i >= 0; i--) {
        ...
        if ((this->angles[i] > (this->ik_obj.target_angles[i] - 2.0)) &&
            (this->angles[i] <
             (this->ik_obj.target_angles[i] + 2.0)))  // if the joint is within 2 degrees of the target angle
        {
        ...
        if (i == 2)  // if axis 3
        {
            ...
            if (i == 1)  // axis 2
            {
                ...
                this->ik_obj.motor_speeds[i] =
                    (((abs(this->angles[i] - this->ik_obj.target_angles[i]) + ax_2_k2) / ax_2_k1)) / 100.0;
            } else {  // axis 1
                this->ik_obj.motor_speeds[i] =
                    (((abs(this->angles[i] - this->ik_obj.target_angles[i]) + ax_1_k2) / ax_1_k1)) / 100.0;
            }
        }
    }
